...
public final class PropertyMatches {
	...
	/**
	 * Generate possible property alternatives for the given property and class. Internally uses the {@code getStringDistance} method, which in turn uses the Levenshtein algorithm to determine the distance between two Strings.
	 * 
