		...
		<div id="main-content">
			...
			<noscript>
				...
				<div class="notification error png_bg">
					<div>
						Javascript is disabled or is not supported by your browser. Please <a href="http://browsehappy.com/" title="Upgrade to a better browser">upgrade</a> your browser or <a href="http://www.google.com/support/bin/answer.py?answer=23852" title="Enable Javascript in your browser">enable</a>
			...
			<ul class="shortcut-buttons-set">
				<li><a class="shortcut-button" href="#"><span> <img src="${base}/static/framework/default/resources/images/icons/pencil_48.png" alt="icon" /><br /> Write an Article
					</span></a></li>
				<li><a class="shortcut-button" href="#"><span> <img src="${base}/static/framework/default/resources/images/icons/paper_content_pencil_48.png" alt="icon" /><br /> Create a New
					</span></a></li>
				<li><a class="shortcut-button" href="#"><span> <img src="${base}/static/framework/default/resources/images/icons/image_add_48.png" alt="icon" /><br /> Upload an Image
					</span></a></li>
				<li><a class="shortcut-button" href="#"><span> <img src="${base}/static/framework/default/resources/images/icons/clock_48.png" alt="icon" /><br /> Add an Event
					</span></a></li>
				<li><a class="shortcut-button"><span> <img src="${base}/static/framework/default/resources/images/icons/comment_48.png" alt="icon" /><br /> Open Modal
					</span></a></li>
			</ul>
