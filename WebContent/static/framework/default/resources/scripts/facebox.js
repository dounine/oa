			...
			.extend(
					$.facebox,
					{
						settings : {
							opacity : 0,
							overlay : true,
							loadingImage : baseUrl + '/static/framework/default/img/loading.gif',
							closeImage : baseUrl + '/static/framework/default/resources/images/closelabel.gif',
              ...
              <td class="body"> \
                ...
                <div class="footer"> \
                  <a href="#" class="close"> \
                    <img src="'
									+ baseUrl
									+ '/static/framework/default/resources/images/closelabel.gif" title="close" class="close_image" /> \
                  </a> \
                </div> \
              </td> \
              <td class="b"/> \
